...
class PontosRepositorios extends ChangeNotifier {
  final List<Ponto> _pontos = [
    Ponto(
     ...
     Ponto(
      ...
      longitude :-43.94314675009581,
       ...
       Ponto(
      nome: 'Mineirao ',
      endereco: 'Av. Antônio Abrahão Caram, 1001 - São José, Belo Horizonte - MG, 31275-000',
      foto:
    ...
    longitude : -43.9711636899104,
      ...
      endereco: 'Av.Praça Sete de Setembro, s/n - Centro, Belo Horizonte - MG, 30160-041 ',
      foto:
      ...
      longitude : -43.93363502059448,
       ...
       Ponto(
      nome: 'Praça do papa ',
      endereco: 'Praça do Papa - Praça Gov. Israel Pinheiro - Mangabeiras, Belo Horizonte - MG, Brasil',
      foto:
     ...
     Ponto(
      ...
      endereco: 'R. Pedro José Pardo, 1000 - Mangabeiras, Belo Horizonte - MG, 47512-000',
      foto:
     ...
     Ponto(
      ...
      endereco: 'igreja da pampulha - São Luiz, Belo Horizonte - MG, 31365-450',
      foto:
     ...
     Ponto(
      nome: 'Museu Mineiro  ',
      endereco: 'Av. João Pinheiro, 342 - Lourdes, Belo Horizonte - MG, 30130-180',
      foto:
     ...
     Ponto(
      ...
      endereco: 'Av. Otacílio Negrão de Lima, 4188 - Bandeirantes (Pampulha), Belo Horizonte - MG, 03165-450',
      foto:
